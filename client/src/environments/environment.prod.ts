export const environment = {
    production: true,
    apiBaseUrl: '/api',
    hubUrl: '/hubs/ghostlist',
    nativeApiBaseUrl: 'https://app.ghost-list.com/api',
    nativeHubUrl: 'https://app.ghost-list.com/hubs/ghostlist',
    nativeShareBaseUrl: 'https://app.ghost-list.com',
    firebase: {
